...
def updateScore():
    ...
    SCORE+=1
    scoreText = font.render(f'Score: {SCORE}', True, (255,255,204), (0,0,0))


def checkCollision():
    global SCREEN_WIDTH,paddle,BALL_X,BALL_Y,BALL_X_SPEED,BALL_Y_SPEED,GAME_S
    if paddle.x<0:
        paddle.x=0
    ...
    if BALL_Y+13>=paddle.y-5 and GAME_STARTED==True and BALL_X>paddle.x and B
        BALL_Y-=15
        BALL_Y_SPEED=-BALL_Y_SPEED
        updateScore()
